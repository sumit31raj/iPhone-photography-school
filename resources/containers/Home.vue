		...
		<div class="custom--container">
			<div class="flex--box">
				<div class="blog--content">
					<div>
						<h2 class="blog--title"> 10 Best Photo Apps For Incredible iPhone Photography (2020 Edition) </h2>
					</div>
					<div class="divider"></div>
					<div class="blog--data">
						<p class="intor"> How do you capture more interesting travel photos with your iPhone? How do you avoid taking the same 
						cliché vacation photos that everyone else takes? I recently interviewed Steffen Geldner – a talented iPhone 
						photographer with a passion for travel. In this article, Steffen reveals 7 tips for shooting beautiful travel 
						photos that will preserve the amazing memories of your trip. Read on to discover how to take better travel photos
						with your iPhone! </p>
						<div class="blog--img">
							<img src="images/demo01.svg">
						</div>
						<article>
							<h3> 1. Research Your Destination To Find The Best Photo Opportunities </h3>
						...
						<article>
							<h3> 2. Capture Your Journey To Tell The Complete Story Of Your Travels </h3>
							...
							<p>If you’re traveling by plane, try too get a window seat where you have a view of the wing or propeller.</p>
